...
def inject_global_styles():
    ...
    div[data-testid="stSegmentedControl"] [role="radio"] {
        ...
        border-top: 1px solid rgba(123,150,188,0.14) !important;
        border-bottom: 1px solid rgba(123,150,188,0.14) !important;
        border-left: 1px solid rgba(123,150,188,0.14) !important;
    ...
    div[data-testid="stSegmentedControl"] [role="radio"]:last-child {
        border-right: 1px solid rgba(123,150,188,0.14) !important;
    }

    div[data-testid="stSegmentedControl"] [role="radio"][aria-checked="true"] {
        background: rgba(62, 19, 22, 0.35) !important;
        color: #ff6d63 !important;
        border: 1px solid rgba(255, 97, 92, 0.9) !important;
        position: relative;
        z-index: 2;
    }
